...
template <typename T>
inline T *ObjectWrapper<T>::GetCppObject()
{
    return cpp_obj.get();
}

template <typename T>
inline void ObjectWrapper<T>::SetupBindings()
{
    auto env = this->Env();
    auto obj = this->Value();
...
template <typename T>
inline void ObjectWrapper<T>::SetupIntrospection()
{
    auto env = this->Env();
    auto obj = this->Value();
...
template <typename T>
Napi::FunctionReference ObjectWrapper<T>::constructor;

// ================================================

template <typename T>
inline void
JsGenerator::bind_class(const std::string &class_name)
{
...
inline JsGenerator::JsGenerator(Napi::Env env,
                                                              Napi::Object exports)
