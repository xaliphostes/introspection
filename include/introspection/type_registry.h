...
#define REGISTER_TYPE(TypeName)                                                                 \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            TypeName##_Registrar()                                                              \
            {                                                                                   \
                introspection::TypeNameRegistry::instance().register_type<TypeName>(#TypeName); \
            }                                                                                   \
        };                                                                                      \
...
#define REGISTER_TYPE_AS(TypeName, CustomName)                                                   \
    ...
    {                                                                                            \
        ...
        {                                                                                        \
            TypeName##_Registrar()                                                               \
            {                                                                                    \
                introspection::TypeNameRegistry::instance().register_type<TypeName>(CustomName); \
            }                                                                                    \
        };                                                                                       \
        static TypeName##_Registrar TypeName##_registrar_instance;                               \
    }
...
public:                                                                                       \
    ...
    {                                                                                         \
        ...
        if (!initialized)                                                                     \
        {                                                                                     \
            introspection::TypeNameRegistry::instance().register_type<ClassName>(#ClassName); \
