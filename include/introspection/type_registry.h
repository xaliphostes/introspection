...
#define REGISTER_TYPE(TypeName)                                                  \
    ...
    {                                                                            \
        ...
        {                                                                        \
            TypeName##_Registrar()                                               \
            {                                                                    \
                TypeNameRegistry::instance().register_type<TypeName>(#TypeName); \
            }                                                                    \
        };                                                                       \
...
#define REGISTER_TYPE_AS(TypeName, CustomName)                                    \
    ...
    {                                                                             \
        ...
        {                                                                         \
            TypeName##_Registrar()                                                \
            {                                                                     \
                TypeNameRegistry::instance().register_type<TypeName>(CustomName); \
            }                                                                     \
        };                                                                        \
        static TypeName##_Registrar TypeName##_registrar_instance;                \
    }
...
public:                                                                        \
    ...
    {                                                                          \
        ...
        if (!initialized)                                                      \
        {                                                                      \
            TypeNameRegistry::instance().register_type<ClassName>(#ClassName); \
